package com.synechron.basiclearning.hellodemo;
...
public class HelloWorld
{
		...
		public static void main(String[] args)
		{
			...
			char randomChar = 58; // Character Code for A is 65 Minimum value 0 Maximum value 65535
			char anotherChar = 'B';
			System.out.println("Randomchar value:"+randomChar+"  "+"Char value:"+anotherChar);
			...
			// used instead
			double aDoubleValue = 45.1456789;
			int doubleToInt;
